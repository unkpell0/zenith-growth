...
const problems = [
  { id: 1, text: "Budget Iklan Habis, Hasil NIHIL?", icon: <CurrencyDollarIcon className="w-10 h-10 text-icon-blue" /> },
  { id: 2, text: "Banyak Prospek Masuk, Tapi Closing JARANG?", icon: <ChatBubbleIcon className="w-10 h-10 text-icon-blue" /> },
  { id: 3, text: "Tim Penjualan Kurang Greget, Prospek Lepas?", icon: <UsersIcon className="w-10 h-10 text-icon-blue" /> },
  { id: 4, text: "Targeting Kurang Tepat, Hasil Jauh dari Harapan?", icon: <TargetIcon className="w-10 h-10 text-icon-blue" /> },
  { id: 5, text: "Kompetitor Semakin Jauh, Anda Tertinggal?", icon: <LightbulbIcon className="w-10 h-10 text-icon-blue" /> },
];
    ...
    <section id="tentang" className="py-16 md:py-24 bg-transparent">
      <div className="container mx-auto px-4 sm:px-6">
        <h2 className="text-section-heading font-semibold text-center text-brand-text-light mb-12 md:mb-16 tracking-tight leading-section-heading">
          Apakah Ini <span className="text-brand-primary">Tantangan Marketing</span> Anda Sehari-hari?
        </h2>
